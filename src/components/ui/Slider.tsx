...
export const Slider = forwardRef<HTMLInputElement, SliderAdapterProps>(function Slider(
  ...
  return (
    <>
      ...
      >
        <RadixSlider.Track className="relative h-2.5 w-full grow overflow-hidden rounded-full bg-[var(--surface-soft)]">
          <RadixSlider.Range className="absolute h-full rounded-full bg-gradient-to-r from-emerald-500 to-emerald-300" />
        </RadixSlider.Track>
        <RadixSlider.Thumb
          className="block h-5 w-5 rounded-full border-2 border-emerald-200 bg-[var(--surface-contrast)] shadow-[0_0_0_3px_rgba(16,185,129,0.35)] transition-colors hover:bg-[var(--card)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-emerald-300)] disabled:pointer-events-none disabled:opacity-50"
