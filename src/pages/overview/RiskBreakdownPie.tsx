...
export default function RiskDistributionPie({ risks }: RiskDistributionPieProps) {
    const data = [
        { name: 'Critical', value: risks.filter((r) => r.riskLevel === 'high').length, color: '#ef4444' }, // red-500
        { name: 'Warning', value: risks.filter((r) => r.riskLevel === 'medium').length, color: '#eab308' }, // yellow-500
